...
public class TreeTableViewSample extends Application {
	...
	final TreeItem<Employee> rootFolder =
	...
	public void start(Stage stage) {
		...
		employees.each{employee->
			rootFolder.getChildren().add(new TreeItem<>(employee));
		};
...
//		);
		...
		TreeTableView<Employee> treeTableView = new TreeTableView<>(rootFolder);
