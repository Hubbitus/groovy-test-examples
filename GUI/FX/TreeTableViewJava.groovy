...
/**
 * Slightly modified (only Java8 to Groovy closures style) from https://docs.oracle.com/javase/8/javafx/user-interface-tutorial/tree-table-view.htm
 *
 * @author Pavel Alexeev - <Pahan@Hubbitus.info> (pasha)
 * @created 2015-01-08 00:15
 * */
...
public class TreeTableViewJava extends Application {
